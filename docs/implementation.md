...
> Except for the code block itself, none of the above is done by 🔥. It's actually customized by the template, which provides links to the source file, sub-block links and breadcrumbs (See [Block Definition](#block-definition)) for lower block levels. Also the `utility-functions` bullet is not a link because the block hasn't been rendered anywhere in the output. The markdown template prints an error for blocks that are referenced but not rendered <font color="red">RefInvalidSlug(utility-functions)</font> or that are referenced but don't exist at all <font color="red">RefInvalidSlug(missing-block)</font>.
...
#### <a name="entry-point"></a>🚀**Entry-point**🚗: [../illiterally/illiterally.py: 147](../illiterally/illiterally.py)
___
```python
# class State:
...
#### <a name="block-definition"></a>🚀**Block Definition**🚗: [../illiterally/illiterally.py: 14](../illiterally/illiterally.py)
___
```python
...
#### <a name="block-reader"></a>🚀**Block Reader**🚗: [../illiterally/illiterally.py: 44](../illiterally/illiterally.py)
___
```python
# class BlockReader:
...
#### <a name="parser-state"></a>🚀**Parser state**🚗: [../illiterally/illiterally.py: 77](../illiterally/illiterally.py)
___
```python
...
#### <a name="entry-point-for-parsing"></a>🚀**Entry point for parsing**🚗: [../illiterally/illiterally.py: 47](../illiterally/illiterally.py)
___
```python
#     @staticmethod
...
#### <a name="block-parsing"></a>🚀**Block parsing**🚗: [../illiterally/illiterally.py: 106](../illiterally/illiterally.py)
___
```python
...
#### <a name="bracket-detection"></a>🚀**Bracket Detection**🚗: [../illiterally/illiterally.py: 96](../illiterally/illiterally.py)
___
```python
