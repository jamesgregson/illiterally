...
For an overview of how 🔥 works, check out [the implementation notes](./docs/implementation.md), e.g. here's a link to the [Block Reader](docs/implementation.md#block-reader).